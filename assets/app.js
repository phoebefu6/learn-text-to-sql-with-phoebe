...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = mx
        ? ["a1-self-serve-dream.html", "a2-accuracy-cliff.html",
           "a3-vendor-landscape.html", "a4-curation-tax.html",
           "a5-governance-trust.html", "a6-adoption-playbook.html"]
        : ["b1-baseline-agent.html", "b2-schema-linking.html", "b3-few-shot-examples.html",
           "b4-rag-over-metadata.html", "b5-semantic-layer.html",
           "b6-self-correction.html", "b7-multi-candidate.html",
           "b8-evaluation.html", "b9-framework-tour.html", "b10-capstone-production.html"];
